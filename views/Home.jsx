        ...
        return(
            ...
            <body>  
                ...
                <div className='landing'>
                    {user ? 
                        <div className='greetingContain'><div className='greeting'> Welcome, {user.name}</div></div>
                        :
                        <div className='greetingContain'><div className='greeting'> Welcome, Stranger</div></div>
                    }
