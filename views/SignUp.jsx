                ...
                <div className='container'>
                   <div className='section'>
                        <form>
                            ...
                            <div className='fg'>
                                <input className='fs' type='text' name='username' placeholder='Your Username' id='logusername' required></input>
                                 <i className='input-icon fa-solid fa-at'></i>
                            </div>
                            <div className='username error'></div>
                            <div className='fg'>
                                <input id='pass' className='fs' type='password' name='password' placeholder='Your Password' log='logpass' required></input>
